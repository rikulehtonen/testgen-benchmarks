...
b = Browser(timeout="3000 s", retry_assertions_for="3000 ms")
...
b.click("xpath=//BUTTON[@class='ProductCard_button__vt_QY'][@product-name='RoboVac_Ultra'][contains(text(),'Add to Cart')]")
